...
export declare const performOpenAgentListScreen: (customerManaged: ModelsCrm.CustomerManaged, currentDeal: ModelsCrm.Deal, agentListContextMode: Enums.AgentListContextMode, agentListAccessLevel: Enums.AgentListAccessLevel) => Action<PERFORM_OPEN_AGENT_LIST_SCREEN>;
/**
...
export declare const performSaveSuccess: (data: boolean, currentDeal: ModelsCrm.Deal) => Action<PERFORM_SAVE_SUCCESS>;
