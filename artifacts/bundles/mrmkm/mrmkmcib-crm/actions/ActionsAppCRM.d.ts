...
export declare const performInputFilterOrganizationStructure: (value: Enums.FilterOrganizationStructure) => Action<PERFORM_INPUT_FILTER_ORGANIZATION_STRUCTURE>;
/**
...
export declare const performInputFilterMemberRole: (value: Enums.FilterMemberRole) => Action<PERFORM_INPUT_FILTER_MEMBER_ROLE>;
/**
...
export declare const performSearchTypeChange: (customerSearchType: any) => Action<PERFORM_SEARCH_TYPE_CHANGE>;
/**
