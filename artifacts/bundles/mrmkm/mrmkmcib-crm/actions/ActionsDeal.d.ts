...
export declare const performDealRefreshMode: (mode: Enums.DealRefreshMode) => Action<PERFORM_DEAL_REFRESH_MODE>;
...
export declare const swapContext: (navigationType: any) => Action<SWAP_CONTEXT>;
