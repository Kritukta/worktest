...
export declare const performInputSumString: (value: string) => Action<PERFORM_INPUT_SUM_STRING>;
export declare type PERFORM_INPUT_EQUIVALENT_SUM_STRING = {
    value: string | null;
};
export declare const performInputEquivalentSumString: (value: string) => Action<PERFORM_INPUT_EQUIVALENT_SUM_STRING>;
export declare type PERFORM_INPUT_TRANSFER_COMMISSION = {
    value: string | null;
};
export declare const performInputTransferCommission: (value: string) => Action<PERFORM_INPUT_TRANSFER_COMMISSION>;
export declare type PERFORM_INPUT_STAFF_COUNT = {
    value: string | null;
};
export declare const performInputStaffCount: (value: string) => Action<PERFORM_INPUT_STAFF_COUNT>;
export declare type PERFORM_INPUT_EQUIVALENT_CONVERSION_RATE_STRING = {
    value: string | null;
};
export declare const performInputEquivalentConversionRateString: (value: string) => Action<PERFORM_INPUT_EQUIVALENT_CONVERSION_RATE_STRING>;
/**
...
export declare const performInputDealDate: (value: Date) => Action<PERFORM_INPUT_DEAL_DATE>;
/**
...
export declare const performInputOperUuid: (activityOperUuid: ModelsDealEditor.ActivityOperUuid) => Action<PERFORM_INPUT_OPERUUID>;
...
export declare const setValidationError: (validationError: Error) => Action<SET_VALIDATION_ERROR>;
...
export declare const performSelectChance: (inputChance: string) => Action<PERFORM_SELECT_CHANCE>;
