...
export declare const dealListReduce: (currentUser: ModelsApp.Employee, infoMessage: string, isCreateDealEnable: boolean, isEditDealEnable: boolean, isButtonCreateVisible: boolean) => Action<DEAL_LIST_REDUCE>;
/**
