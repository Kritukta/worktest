...
export declare const navigateToNoteTypePickerScreen: (index: number) => Action<NAVIGATE_TO_NOTE_TYPE_PICKER_SCREEN>;
/**
 * Thunk dispatched by "NoteList" screen. Thunk dispatched on user tap Note type field.
 *
 * @param {number | null} index .
...
export declare const performNoteUpdate: (text: string, type: ModelsApp.Classifier) => Action<PERFORM_NOTE_UPDATE>;
/**
...
export declare const performNoteTypeUpdate: (type: ModelsApp.Classifier) => Action<PERFORM_NOTE_TYPE_UPDATE>;
/**
