...
export declare const performOpenOccasionListScreen: (occasionListContextMode: Enums.OccasionListContextMode, occasionListAccessLevel: Enums.OccasionListAccessLevel, agent: ModelsCrm.Agent, customer: ModelsCrm.CustomerManaged) => Action<PERFORM_OPEN_OCCASION_LIST_SCREEN>;
/**
