...
export declare const performInputPaymentScheduleFilterPeriodStart: (value: Date) => Action<PERFORM_INPUT_PAYMENT_SCHEDULE_FILTER_PERIOD_START>;
/**
 * Thunk dispatched by "ProductCredit" screen. Thunk dispatched on user input field value.
 *
 * @param {Date | null} value .
...
export declare const performInputPaymentScheduleFilterPeriodEnd: (value: Date) => Action<PERFORM_INPUT_PAYMENT_SCHEDULE_FILTER_PERIOD_END>;
/**
 * Thunk dispatched by "ProductCredit" screen. Thunk dispatched on user input field value.
 *
 * @param {Date | null} value .
...
export declare const performInputPaymentScheduleFilterPeriodStartApplied: (value: Date) => Action<PERFORM_INPUT_PAYMENT_SCHEDULE_FILTER_PERIOD_START_APPLIED>;
/**
 * Thunk dispatched by "ProductCredit" screen. Thunk dispatched on user input field value.
 *
 * @param {Date | null} value .
...
export declare const performInputPaymentScheduleFilterPeriodEndApplied: (value: Date) => Action<PERFORM_INPUT_PAYMENT_SCHEDULE_FILTER_PERIOD_END_APPLIED>;
/**
...
export declare const performChangeCovenantDateFilterValue: (value: Date) => Action<PERFORM_CHANGE_COVENANT_DATE_FILTER_VALUE>;
/**
...
export declare const performInputForecastEventDate: (value: Date) => Action<PERFORM_INPUT_FORECAST_EVENT_DATE>;
/**
 * Thunk dispatched by "ProductCredit" screen. Thunk used to show value picker screen.
 *
 */
...
export declare const performInputForecastEventSum: (value: string) => Action<PERFORM_INPUT_FORECAST_EVENT_SUM>;
/**
 * Thunk dispatched by "ProductCredit" screen. Thunk dispatched on user input field value.
 *
 * @param {number | null} value .
...
export declare const performPaymentScheduleFilterPeriodSet: (valueDateStart: Date, valueDateEnd: Date) => Action<PERFORM_PAYMENT_SCHEDULE_FILTER_PERIOD_SET>;
/**
 * Thunk dispatched by "ProductCredit" screen. Fetch forecast events list with cache flushed.
 *
 */
...
export declare const performPaymentScheduleAlertShow: (paymentScheduleAlternativeScenariosType: Enums.paymentScheduleAlternativeScenariosType, paymentScheduleAlternativeScenariosMessage: string, paymentScheduleAlternativeScenariosTitle: string) => Action<PERFORM_PAYMENT_SCHEDULE_ALERT_SHOW>;
/**
 * Internal thunk used in "Customer" container to hide product list modal alert
 */
...
export declare const performPaymentScheduleErrorShow: (paymentScheduleAlternativeScenariosType: Enums.paymentScheduleAlternativeScenariosType, paymentScheduleAlternativeScenariosMessage: string, paymentScheduleAlternativeScenariosTitle: string) => Action<PERFORM_PAYMENT_SCHEDULE_ERROR_SHOW>;
/**
 * Internal thunk used in "Customer" container to hide product list modal alert
 */
