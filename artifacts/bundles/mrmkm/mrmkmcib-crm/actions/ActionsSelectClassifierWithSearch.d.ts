...
export declare const performInit: (list: ModelsApp.ClassifierList, value: string, mode: Enums.ClassifierMode, pageName: string, navigateBackButtonTitle: string, isFullScreenEnabled: boolean) => Action<PERFORM_INIT>;
...
export declare const setClassifierWarning: (warningMessage: string) => Action<SET_CLASSIFIER_WARNING>;
