...
export declare const getGeneralPersonMemberList: (memberList: ModelsCrm.MemberList) => ModelsApp.Employee;
...
export declare const urlCustomer: {
    ...
    callGetRequestProductList: (state: ModelState.IRootState, active: boolean, pollingStatus: Enums.ProductPollingStatus, operationUuid: string, service: string, currentCustomerId: string, isForceRequest: boolean, ttl: string, tagList: ModelsCrm.CacheTag[]) => ModelsCrm.Url;
...
export declare const displayCustomerWithLegalForm: (customer: ModelsCrm.Customer) => string;
...
export declare const urlProductCredit: {
    ...
    callGetCovenantList: (state: ModelState.IRootState, customer: ModelsCrm.Customer, contractNumber: string, tagList: ModelsCrm.CacheTag[]) => ModelsCrm.Url;
...
export declare const getProductCreditCovenantStatus: (filterValueDate: Date, historyList: ModelsCrm.ProductCovenantHistoryList) => string;
export declare const getCRMErrorMessageByCode: (code: string) => string;
export declare const call: <T, TB>(url: ModelsCrm.Url, success: (response: Response<T>) => void, failure: (response: Error) => void, converter: (data: any) => T, method?: string, headers?: any, requestConverter?: (data: TB) => any, requestData?: TB) => void;
...
export declare const getTroubleGroupCodeString: (key: number, onlyColor?: boolean) => string;
...
export declare const getErrorProductList: (reducerState: ModelsCustomer.ICustomerState, productType: Enums.ProductType, isActiveProductList: boolean) => ModelsCrm.Error;
...
export declare const getRoleByOrganizationTypeString: (key: string, organizationTypeCode: string) => string;
...
export declare const getNumberDataDisplayValue: (data: number, placeholderType?: UndefinedValuesPlaceholder) => string | number;
export declare const getGroupProductListByCurrency: (currency: ModelsApp.Classifier, groupProductList: ModelsCrm.GroupCurrencyProductList) => ModelsCrm.GroupCurrencyProductData;
...
export declare const isPollingStatusInProgress: (productPollingStatus: Enums.ProductPollingStatus) => boolean;
...
export declare const parseServerDate: (data: string) => Date;
export declare const getIsActiveAgreementProductText: (activeAgreement: boolean) => string;
export declare const getClassifierDataDisplayValue: (data: ModelsApp.Classifier, placeholderType?: UndefinedValuesPlaceholder) => ModelsApp.Classifier;
export declare const searchGszMemberList: (list: ModelsCrm.GszMember[], inputSearch: string) => ModelsCrm.GszMember[];
export declare const getStringDataDisplayValue: (data: string, placeholderType?: UndefinedValuesPlaceholder) => string;
...
export declare const currencyString: (c: string | ModelsApp.Classifier) => string;
export declare const unique: <T, R>(arr: T[], selector?: (e: T) => T | R) => T[];
export declare const formatNumberAsSum: (num: string | number, base?: number) => string;
export declare const format: {
    sum: (num: number, base: number, curr: string | ModelsApp.Classifier, undefinedPlaceholder?: string) => string;
    date: (d: Date, fmt?: string) => string;
    percents: (v: string | number) => string;
...
export declare const getDealFilteredList: (dealList: ModelsCrm.DealList, start: Date, end: Date) => ModelsCrm.DealList;
/**
...
export declare const getDealTypeTitle: (type: Enums.DealType, requestType: ModelsApp.Classifier) => string;
...
export declare const getAgentCustomerPositionByAgentListContext: (customer: ModelsCrm.CustomerManaged, agent: ModelsCrm.Agent, agentListContextMode: Enums.AgentListContextMode) => string;
export declare const getAgentCustomerPosition: (customer: ModelsCrm.CustomerManaged, agent: ModelsCrm.Agent) => string;
export declare const getAgentCustomerCompany: (customer: ModelsCrm.Customer, agent: ModelsCrm.Agent) => string;
export declare const parseFullName: (fullName: string) => ModelsCrm.Agent;
export declare const getAgentNameInitials: (agent: ModelsCrm.Agent | ModelsApp.Employee) => string;
export declare const getAgentFullName: (agent: ModelsCrm.Agent | ModelsApp.Employee) => string;
...
export declare const getAgentInitials: (agent: ModelsCrm.Agent | ModelsApp.Employee) => string;
...
export declare const getDealList: (dealList: ModelsCrm.DealList, filterState: (deal: ModelsCrm.Deal) => boolean, filter: ModelsCrm.DealListFilter, getDate: (deal: ModelsCrm.Deal) => Date) => ModelsCrm.DealList;
...
export declare const detectUnits: (num: number, units: string[]) => string;
export declare const detectUnitsString: (str: string, units: string[]) => string;
export declare const isDealManaged: (team: ModelsApp.Employee[], user: ModelsApp.Employee) => boolean;
export declare const myRoleInDeal: (team: ModelsApp.Employee[], user: ModelsApp.Employee) => ModelsApp.Classifier;
...
export declare const setAccessLevelToAgent: (member: ModelsApp.Employee) => Enums.AgentAccessLevel;
...
export declare const getWorkPhone: (phoneList: ModelsCrm.PhoneNumberList) => string;
export declare const getMobilePhone: (phoneList: ModelsCrm.PhoneNumberList) => string;
export declare const getValidationgErrorText: (attribute: Enums.AgentValidationAttribute) => string;
export declare const isAgentValidateFirstNameFailed: (firstName: string) => boolean;
export declare const isAgentValidateLastNameFailed: (lastName: string) => boolean;
export declare const isAgentValidateMiddleNameFailed: (middleName: string) => boolean;
export declare const isAgentValidateJobPositionFailed: (jobPosition: string) => boolean;
export declare const isAgentValidateWorkPhoneFailed: (workPhone: string) => boolean;
export declare const isAgentValidateMobilePhoneFailed: (mobilePhone: string) => boolean;
export declare const isAgentValidateEmailFailed: (email: string) => boolean;
export declare const isAgentValidateBirthdayFailed: (birthday: Date) => boolean;
...
export declare const isAgentValidateRelationTypeFailed: (relationType: ModelsApp.Classifier) => boolean;
export declare const isAgentValidateCommentFailed: (comment: string) => boolean;
export declare const occasionValidationType: (type: ModelsApp.Classifier) => string;
export declare const occasionValidationDate: (date: Date) => string;
...
export declare const noteListUpdate: (noteList: ModelsCrm.NoteList, index: number, text: string, type: ModelsApp.Classifier) => ModelsCrm.NoteList;
 ...
 */
export declare const searchAffiliateList: (affiliateList: ModelsCrm.CustomerList, inputSearchAffiliateList: string) => ModelsCrm.Customer[];
...
export declare const customerActivityIncludeValidationComment: (comment: string, user: ModelsApp.Employee) => string;
export declare const customerActivityIncludeValidationCustomer: (customer: ModelsCrm.Customer, user: ModelsApp.Employee, currentCustomerManaged: ModelsCrm.CustomerManaged, currentCustomer: ModelsCrm.Customer) => string;
...
export declare const customerActivityExcludeValidationComment: (comment: string, user: ModelsApp.Employee) => string;
export declare const customerActivityExcludeValidationCustomer: (customer: ModelsCrm.Customer, user: ModelsApp.Employee, currentCustomerManaged: ModelsCrm.CustomerManaged, currentCustomer: ModelsCrm.Customer) => string;
export declare const gszActivityExcludeValidationComment: (comment: string, user: ModelsApp.Employee) => string;
export declare const gszActivityExcludeValidationCustomer: (customer: ModelsCrm.Customer, user: ModelsApp.Employee) => string;
...
export declare const gszActivityIncludeValidationComment: (comment: string, user: ModelsApp.Employee) => string;
export declare const gszActivityIncludeValidationCustomer: (customer: ModelsCrm.Customer, user: ModelsApp.Employee) => string;
export declare const sortCurrencyListAsInOrder: (currencyList: ModelsApp.Classifier[], orderList: string[]) => ModelsApp.Classifier[];
export declare const extractCurrencyList: (productList: ModelsCrm.CreditProductList | ModelsCrm.DepositProductList | ModelsCrm.SettlementAgreementProductList | ModelsCrm.CorporateCardProductList | ModelsCrm.EncashmentContractProductList | ModelsCrm.AcquiringProductList | ModelsCrm.DboProductList | ModelsCrm.SalaryProductList | ModelsCrm.UdboProductList | ModelsCrm.LegalInfoProductList, type: Enums.ProductType) => ModelsApp.ClassifierList;
export declare const extractEncumbranceList: (productList: ModelsCrm.CreditProductList | ModelsCrm.DepositProductList | ModelsCrm.SettlementAgreementProductList | ModelsCrm.CorporateCardProductList | ModelsCrm.EncashmentContractProductList | ModelsCrm.AcquiringProductList | ModelsCrm.DboProductList | ModelsCrm.SalaryProductList | ModelsCrm.UdboProductList | ModelsCrm.LegalInfoProductList, productType: Enums.ProductType) => ModelsCrm.ProductEncumbranceList;
...
export declare const operationListFilter: (operationList: ModelsCrm.PaymentAccountProductOperationList, start: Date, end: Date, periodType: Enums.PeriodType, operationType: Enums.OperationType, sumMin: number, sumMax: number) => ModelsCrm.PaymentAccountProductOperationList;
export declare const forecastEventListFilter: (forecastEventList: ModelsCrm.ForecastEventList, start: Date, end: Date, periodType: Enums.ForecastPeriodType, forecastEventType: ModelsApp.Classifier) => ModelsCrm.ForecastEventList;
/**
...
export declare const getCustomerActivityIncludeExecutor: (customerManager: ModelsCrm.Customer | ModelsCrm.CustomerManaged) => ModelsApp.Employee;
...
export declare const getCustomerActivityExcludeExecutor: (customerManager: ModelsCrm.CustomerManaged) => ModelsApp.Employee;
export declare const setProductEksErrorMessage: (eksErrorList: ModelsCrm.EksErrorList) => Error;
...
export declare const isClientNotFoundInEksSystem: (error: ModelsCrm.Error) => boolean;
export declare const getProductListItemErrorText: (error: ModelsCrm.Error) => string;
...
export declare const eventPossibilityStringValue: (possibility: number) => string;
export declare const eventFilterPeriodStringValue: (type: Enums.ForecastPeriodType) => string;
export declare const productCreditStatus: (type: string) => string;
...
export declare const creditEventValidationEmail: (email: string) => string;
export declare const creditEventValidationCurrency: (currency: ModelsApp.Classifier) => string;
export declare const creditEventValidationSumm: (summ: string) => string;
export declare const creditEventValidationPossibility: (possibility: Enums.ForecastEventPossibility) => string;
export declare const creditEventValidationType: (eventType: ModelsApp.Classifier) => string;
...
export declare const isApprovalStatus: (action: string, approvedStatuses: string) => boolean;
...
export declare const customerEditorAddressValidator: (address: {
    ...
    inputCountryValidationError: string;
    inputSubjectValidationError: string;
    inputRegionValidationError: string;
    inputCityValidationError: string;
    inputSettlementValidationError: string;
    inputStreetValidationError: string;
    inputHouseValidationError: string;
    inputBuildingValidationError: string;
    inputBlockValidationError: string;
    inputFlatValidationError: string;
};
export declare const getEquivalentConversionRate: (sum: number, equivalentSum: number) => number;
export declare const getEquivalentSum: (sum: number, conversionRate: number) => number;
...
export declare const convertStringToNumber: (value: string) => number;
export declare const convertNumberToString: (value: string | number) => string;
...
export declare const getBalanceString: (balance: number, currency: ModelsApp.Classifier) => string;
export declare const getForecastEventSaveErrorComment: (error: Error) => string;
export declare const getRowTemplate: (e: ModelsApp.Classifier, mode?: Enums.ClassifierMode) => string;
...
export declare const prepareActivityUuid: (activityList: ModelsScheduler.ActivityList) => ModelsDealEditor.ActivityOperUuid;
export declare const getClientCardEditableStatus: (status: ModelsApp.Classifier) => boolean;
export declare const secureParseFloat: (value: string) => number;
...
export declare const prepareDate: (value: Date) => Date;
...
export declare const getMethodClassifierWarningMessage: (troubleGroup: string) => string;
/**
 ...
 */
export declare const getPersonInTeam: (member: ModelsApp.Employee, memberList: ModelsCrm.MemberList) => ModelsApp.Employee;
 ...
 * @returns { ModelsApp.ClassifierList }
 */
export declare const getAccessibleStageList: (value: ModelsApp.Classifier, list: ModelsApp.ClassifierList) => ModelsApp.ClassifierList;
/**
 * @author Romanov Andrey <romanov.a.mikhayl@sberbank.ru>
 *
 ...
 */
export declare const getPossibleSalesStageByCode: (array: ModelsCrm.NextStage[], code: string) => ModelsCrm.NextStage;
/**
 * @author Romanov Andrey <romanov.a.mikhayl@sberbank.ru>
 *
 * getTrackingElement
...
export declare const getTrackingElement: {
    byCrmStage: (trackingList: ModelsCrm.DealStageTracking, searchKey: string) => ModelsCrm.Tracking;
    byClientStage: (trackingList: ModelsCrm.DealStageTracking, searchKey: string) => ModelsCrm.Tracking;
};
/**
 * @author Romanov Andrey <romanov.a.mikhayl@sberbank.ru>
 *
...
export declare const convertToUTCDateFormat: (date: Date) => string;
 ...
 * @returns { number | null }
 */
export declare const getPaymentScheduleOperCode: (value: string) => number;
/**
 *  Get Payment Schedule OperCode
 ...
 * @returns { string }
 */
export declare const getPaymentScheduleStatusName: (value: string) => string;
/**
 ...
 * @returns { number | null}
 */
export declare const getPaymentScheduleStatus: (value: string) => number;
/**
 ...
 */
export declare const downloadAndSaveInCahce: (ECMFileId: string, state: ModelState.IRootState) => any;
...
export declare const getOtherFormat: (knownFormat: Enums.DealAttachmentsFileFormat, format: string) => string;
 ...
 * @return boolean
 */
export declare const isHandlerFunctionOk: (alertViewType: Enums.paymentScheduleAlternativeScenariosType) => boolean;
/**
 * Get handler event "Cancel" depending on the type
 * @param { Enums.paymentScheduleAlternativeScenariosType | null } alertViewType
 * @return boolean
 */
export declare const isHandlerFunctionCancel: (alertViewType: Enums.paymentScheduleAlternativeScenariosType) => boolean;
/**
 * Get handler event "Repeat" depending on the type
 * @param { Enums.paymentScheduleAlternativeScenariosType | null } alertViewType
 * @return boolean
 */
export declare const isHandlerFunctionRepeat: (alertViewType: Enums.paymentScheduleAlternativeScenariosType) => boolean;
/**
 ...
 * @author - Vladykin A. S.
 */
export declare const sliceLongText: (text: string) => string;
/**
