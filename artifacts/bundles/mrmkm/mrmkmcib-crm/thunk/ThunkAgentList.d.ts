...
export declare const performOpenAgentListScreen: (agentList: Models.AgentList, customerManaged: Models.CustomerManaged, currentDeal: Models.Deal, agentListContextMode: Enums.AgentListContextMode, agentListAccessLevel: Enums.AgentListAccessLevel) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const parseInputString: (inputString: string) => Models.AgentSearchListRequestPerson;
...
export declare const performSaveSuccess: (dealResponse: Models.Deal) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
