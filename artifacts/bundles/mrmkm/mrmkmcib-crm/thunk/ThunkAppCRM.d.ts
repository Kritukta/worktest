...
export declare const performInputFilterOrganizationStructure: (value: Enums.FilterOrganizationStructure) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performInputFilterMemberRole: (value: Enums.FilterMemberRole) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performCustomerOpenExecute: (customer: Models.Customer, customerMode: Enums.CustomerMode, showCustomer?: Enums.ShowCustomer) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerOpenOnce: (customer: Models.Customer, customerMode: Enums.CustomerMode, showCustomer: Enums.ShowCustomer) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performCustomerOpen: (customerId: string, customerMode?: Enums.CustomerMode) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerPassBy: (customerId: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerInnerOpen: (customerId: string, customerMode?: Enums.CustomerMode) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerInnerPassBy: (customerId: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerOpenWithResetPanel: (customerId: string, customerMode?: Enums.CustomerMode) => (dispatch: Function) => void;
...
export declare const performDealOpen: (dealId: string, dealMode: Enums.DealMode, isEditDealEnable: boolean, customerId?: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performProductOpen: (productId: string, productType: Enums.ProductType, customer: Models.Customer, eksId: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performSearchTypeChange: (customerSearchType: any) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performCustomerOpenFromPush: (customerId: string, customerMode?: Enums.CustomerMode) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
/**
...
export declare const performNavigateToCustomerScreen: (customer: Models.Customer, customerMode: Enums.CustomerMode, showCustomer: Enums.ShowCustomer) => (dispatch: Function) => void;
