...
export declare const navigateToDealEditor: (deal: Models.Deal, mode: Enums.DealEditorMode, agentList: Models.AgentList) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performInputSumString: (value: string) => (dispatch: Function) => void;
export declare const performInputEquivalentSumString: (value: string) => (dispatch: Function) => void;
export declare const performInputTransferCommission: (value: string) => (dispatch: Function) => void;
export declare const performInputStaffCount: (value: string) => (dispatch: Function) => void;
export declare const performInputEquivalentConversionRateString: (value: string) => (dispatch: Function) => void;
...
export declare const performValidateForm: (validateMode: Enums.ValidateForm, validateType?: Enums.ValidateFormType) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const setValidationError: (validationError: Error) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performInputDealDate: (value: Date) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performSelectChance: (inputChance: string) => (dispatch: Function) => void;
