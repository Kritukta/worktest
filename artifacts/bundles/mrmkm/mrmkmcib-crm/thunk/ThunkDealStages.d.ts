...
export declare const performInputDealDate: (value: Date) => (dispatch: Function) => void;
export declare const performInputEquivalentSumString: (value: string) => (dispatch: Function) => void;
export declare const performInputEquivalentSum: (value: number) => (dispatch: Function) => void;
