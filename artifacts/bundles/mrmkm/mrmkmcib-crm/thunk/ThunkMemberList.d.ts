...
export declare const performMemberListRefresh: (currentActivity: ModelsScheduler.Activity, currentDeal: Models.Deal, currentCustomerManaged: Models.CustomerManaged, currentGsz: Models.Gsz, currentAgent: Models.Agent, isExpandedMode: boolean, currentMode: Enums.MemberListMode, inputEmployeeSource?: Enums.MemberListEmployeeSource) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
