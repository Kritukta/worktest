...
export declare const performInputSumMin: (value: number, applyFilter?: boolean) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performInputSumMax: (value: number, applyFilter?: boolean) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
