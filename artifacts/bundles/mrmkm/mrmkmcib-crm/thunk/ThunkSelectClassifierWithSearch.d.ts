...
export declare const performInit: (list: ModelsApp.ClassifierList, value: string, mode: Enums.ClassifierMode, pageName: string, navigateBackButtonTitle: string, isFullScreenEnabled: boolean) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const navigateToClassifier: (classifierList: ModelsApp.ClassifierList, initialValue: string, mode: Enums.ClassifierMode, warningMessage?: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const setClassifierWarning: (warningMessage: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
