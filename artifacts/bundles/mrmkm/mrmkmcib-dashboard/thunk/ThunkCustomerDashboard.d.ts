...
export declare const handleQlikError: (error: Error) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const setCurrentCustomerDashboardQlikUrl: (url: string) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
