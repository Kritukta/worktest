...
extern NSString *const kUFSModuleFieldName;
extern NSString *const kUFSSubmoduleFieldName;
extern NSString *const kUFSCodeFieldName;
extern NSString *const kUFSMessageFieldName;
extern NSString *const kUFSErrorDomain;
...
+ (UFSError *)errorWithUFSError:(UFSError *)error
