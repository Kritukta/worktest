/**
 * + `domain` - домен ресурса, от которого получена cookie-информация;
 * + `path` - путь, к которому привязана cookie-информация;
 * + `value` - целевая информация, хранящаяся в виде ключ-значение;
 * + `expiresDate` - дата, после которой данные считаются недействительными.
 * @category Nonvisual
 */
