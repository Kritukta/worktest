...
export default class UFSFileService {
     ...
     * @static
     */
    static create(name: string, type: number): Promise<string>;
    /**
     ...
     * @static
     */
    static append(fileId: string, text: string): Promise<void>;
    /**
     ...
     * @static
     */
    static appendBinary(fileId: string, content: string): Promise<void>;
    /**
     ...
     * @static
     */
    static appendBase64(fileId: string, content: string): Promise<void>;
    /**
     ...
     * @static
     */
    static delete(fileId: string): Promise<void>;
    /**
     ...
     * @static
     */
    static getSize(fileId: string): Promise<number>;
    /**
     ...
     * @static
     */
    static changePersistency(fileId: string, persistenceType: number): Promise<void>;
    /**
     ...
     * @static
     */
    static getFilePath(fileId: string): Promise<string>;
}
