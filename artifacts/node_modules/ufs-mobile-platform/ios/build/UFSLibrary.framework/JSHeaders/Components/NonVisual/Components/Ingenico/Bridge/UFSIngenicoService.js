...
const IngenicoService = NativeModules.UFSIngenicoServiceBridge;
/**
...
export default class UFSIngenicoService {
    ...
    static configure(params) {
        IngenicoService.configure(params);
    }
    /**
     ...
     * @static
     */
    static getAvailableTerminals(callback) {
        IngenicoService.getAvailableTerminals(callback);
    }
    /**
     ...
     * @static
     */
    static selectTerminal(terminal, callback) {
        IngenicoService.selectTerminal(terminal, callback);
    }
    /**
     ...
     * @static
     */
    static connectTerminal() {
        return new Promise((resolve, reject) => {
            IngenicoService.connectTerminal()
                .then(() => {
                resolve();
            })
                .catch((error) => {
     ...
     * @static
     */
    static connectTerminalWithSecurity(sslParams) {
        return new Promise((resolve, reject) => {
            IngenicoService.connectTerminalWithSecurity(sslParams)
                .then(() => {
                resolve();
            })
                .catch((error) => {
     ...
     * @static
     */
    static send(header, body) {
        return new Promise((resolve, reject) => {
            IngenicoService.send(header, body)
                .then((data) => {
                resolve(data);
            })
                .catch((error) => {
...
//# sourceMappingURL=UFSIngenicoService.js.map