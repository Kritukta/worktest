...
export default class UFSMRM {
    ...
    static onSwitch(callback) {
        ...
        if (callback != null) {
            ...
            MRM.registerForEvent(MRMEvents.onSwitch);
        }
        else {
            MRM.unregisterFromEvent(MRMEvents.onSwitch);
        }
    }
    /**
     ...
     * @static
     */
    static onEntrance(callback) {
        MRMEventEmitter.removeAllListeners(MRMEvents.onEntrance);
        if (callback != null) {
            MRMEventEmitter.addListener(MRMEvents.onEntrance, callback, undefined);
            MRM.registerForEvent(MRMEvents.onEntrance);
        }
        else {
            MRM.unregisterFromEvent(MRMEvents.onEntrance);
        }
    }
    /**
    ...
    static onLoad(callback) {
        MRMEventEmitter.removeAllListeners(MRMEvents.onLoad);
        if (callback != null) {
            MRMEventEmitter.addListener(MRMEvents.onLoad, callback, undefined);
            MRM.registerForEvent(MRMEvents.onLoad);
        }
        else {
            MRM.unregisterFromEvent(MRMEvents.onLoad);
        }
    }
    /**
    ...
    static onFinish(callback) {
        MRMEventEmitter.removeAllListeners(MRMEvents.onFinish);
        if (callback != null) {
            MRMEventEmitter.addListener(MRMEvents.onFinish, callback, undefined);
            MRM.registerForEvent(MRMEvents.onFinish);
        }
        else {
            MRM.unregisterFromEvent(MRMEvents.onFinish);
        }
    }
    /**
     ...
     * @static
     */
    static finishLoading(error) {
        return new Promise((resolve, reject) => {
            MRM.finishLoading(error)
                .then(() => {
                resolve();
            })
                .catch((error) => {
     ...
     * @static
     */
    static switchRootApp(bundleName, payload) {
        return new Promise((resolve, reject) => {
            MRM.switchRootApp(bundleName, payload)
                .then(() => {
                resolve();
            })
                .catch((error) => {
     ...
     * @static
     */
    static showModalApp(bundleName, payload) {
        return new Promise((resolve, reject) => {
            MRM.showModalApp(bundleName, payload)
                .then(() => {
                resolve();
            })
                .catch((error) => {
