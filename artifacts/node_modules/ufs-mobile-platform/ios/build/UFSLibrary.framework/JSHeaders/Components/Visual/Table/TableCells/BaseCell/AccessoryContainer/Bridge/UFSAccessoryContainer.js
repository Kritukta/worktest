...
/**
 * Необязательная правая часть ячейки.
 * @category Visual/Table/Base Cells
 */
export default class UFSAccessoryContainerManager extends Component {
    childWithDefaultMargins(child) {
        if (child) {
            if (child.type == Text) {
                return React.cloneElement(child, { style: styles.wrapperViewText });
            }
