...
export const NAVIGATE_TO_MEMBER_LIST_SCREEN_PAGE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_TO_MEMBER_LIST_SCREEN_PAGE'

export const NAVIGATE_TO_CUSTOMER_PICKER_SCREEN = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_TO_CUSTOMER_PICKER_SCREEN'

export const PERFORM_INPUT_SEARCH_MANAGED_ONLY = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_SEARCH_MANAGED_ONLY'

export const PERFORM_INPUT_SEARCH = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_SEARCH'

export const PERFORM_SEARCH_RESET = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH_RESET'

export const PERFORM_SEARCH = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH'

export const FILTER_CUSTOMER_LIST = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_FILTER_CUSTOMER_LIST'

export const PERFORM_INPUT_CUSTOMER = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_CUSTOMER'

export const PERFORM_CHANGE_DISPLAY_ERROR_MODAL_WINDOW = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CHANGE_DISPLAY_ERROR_MODAL_WINDOW'

export const CALL_GET_CUSTOMER = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_GET_CUSTOMER'
export const CALL_GET_CUSTOMER_REQUEST = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_GET_CUSTOMER_REQUEST'
export const CALL_GET_CUSTOMER_SUCCESS = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_GET_CUSTOMER_SUCCESS'
export const CALL_GET_CUSTOMER_FAILURE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_GET_CUSTOMER_FAILURE'

export const PERFORM_INPUT_COMMENT = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_COMMENT'

export const PERFORM_CANCEL = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CANCEL'

export const PERFORM_SAVE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE'
export const PERFORM_SAVE_EXECUTE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_EXECUTE'
export const PERFORM_SAVE_SUCCESS = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_SUCCESS'
export const PERFORM_SAVE_FAILURE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_FAILURE'

export const CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE'
export const CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_REQUEST = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_REQUEST'
export const CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_SUCCESS = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_SUCCESS'
export const CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_FAILURE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_FAILURE'

export const PERFORM_VALIDATE = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_VALIDATE'

export const NAVIGATE_BACK = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_BACK'

export const PERFORM_CONTAINER_RESET = 'CUSTOMER_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CONTAINER_RESET'

export const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_SUCCESS = 'CUSTOMER_ACTIVITY_EXCLUDE_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_SUCCESS'

export const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST = 'CUSTOMER_ACTIVITY_EXCLUDE_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST'

export const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_REQUEST = 'CUSTOMER_ACTIVITY_EXCLUDE_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_REQUEST'

export const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_FAILURE = 'CUSTOMER_ACTIVITY_EXCLUDE_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_FAILURE'

export const PERFORM_SEARCH_SUCCESS = 'CUSTOMER_ACTIVITY_EXCLUDE_PERFORM_SEARCH_SUCCESS'

export const PERFORM_SEARCH_FAILURE = 'CUSTOMER_ACTIVITY_EXCLUDE_PERFORM_SEARCH_FAILURE'

export const SEARCH_VALIDATE_SEARCH = 'CUSTOMER_ACTIVITY_EXCLUDE_SEARCH_VALIDATE_SEARCH'

export const PERFORM_SEARCH_EXECUTE = 'CUSTOMER_ACTIVITY_EXCLUDE_PERFORM_SEARCH_EXECUTE'
...
/*
 * Action dispatched on fetch failure in thunk "search_callGetCustomerSearchList". Internal thunk used in "CustomerActivityExclude" container. Fetch customer list current page with search parameters.
 *
...
/*
 * Action dispatched on network thunk chain "search_callGetCustomerSearchList" started. Internal thunk used in "CustomerActivityExclude" container. Fetch customer list current page with search parameters.
 */
...
/*
 * Action dispatched on fetch succeeded in thunk "search_callGetCustomerSearchList". Internal thunk used in "CustomerActivityExclude" container. Fetch customer list current page with search parameters.
 *
 ...
 */
export type FILTER_CUSTOMER_LIST = { inputSearch: string, inputSearchManagedOnly: boolean, currentCustomerManaged: Models.CustomerManaged, currentCustomer: Models.Customer}
export const filterCustomerList = (inputSearch: string, inputSearchManagedOnly: boolean, currentCustomerManaged: Models.CustomerManaged,currentCustomer: Models.Customer): Action<FILTER_CUSTOMER_LIST> => ({
 ...
 *
 */
export type CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE = {}
export const callPostCustomerActivityExcludeCreate = (): Action<CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE> => ({
    type: CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE,
    payload: {}
})
 ...
 */
export type CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_REQUEST = {}
export const callPostCustomerActivityExcludeCreateRequest = (): Action<CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_REQUEST> => ({
    type: CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_REQUEST,
    payload: {}
})
 ...
 */
export type CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_SUCCESS = { response: Response<boolean> }
export const callPostCustomerActivityExcludeCreateSuccess = (response: Response<boolean>): Action<CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_SUCCESS> => ({
    type: CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_SUCCESS,
    payload: {
        response: response
    }
})
 ...
 * @param {Error} error Description of error while receiving data by fetch.
 */
export type CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_FAILURE = { error: Error }
export const callPostCustomerActivityExcludeCreateFailure = (error: Error): Action<CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_FAILURE> => ({
    type: CALL_POST_CUSTOMER_ACTIVITY_EXCLUDE_CREATE_FAILURE,
    payload: {
        error: error
    }
})
