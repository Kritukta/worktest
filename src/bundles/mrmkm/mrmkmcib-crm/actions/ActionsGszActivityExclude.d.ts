...
export declare const NAVIGATE_TO_CUSTOMER_PICKER_SCREEN = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_TO_CUSTOMER_PICKER_SCREEN";
export declare const NAVIGATE_TO_MEMBER_LIST_SCREEN = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_TO_MEMBER_LIST_SCREEN";
export declare const PERFORM_INPUT_SEARCH_MANAGED_ONLY = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_SEARCH_MANAGED_ONLY";
export declare const PERFORM_INPUT_SEARCH = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_SEARCH";
export declare const PERFORM_SEARCH_RESET = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH_RESET";
export declare const PERFORM_SEARCH_EXECUTE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH_EXECUTE";
export declare const PERFORM_SEARCH_SUCCESS = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH_SUCCESS";
export declare const PERFORM_SEARCH_FAILURE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH_FAILURE";
export declare const SEARCH_VALIDATE_SEARCH = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_SEARCH_VALIDATE_SEARCH";
export declare const PERFORM_SEARCH = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SEARCH";
export declare const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST";
export declare const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_REQUEST = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_REQUEST";
export declare const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_SUCCESS = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_SUCCESS";
export declare const SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_FAILURE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_FAILURE";
export declare const FILTER_CUSTOMER_LIST = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_FILTER_CUSTOMER_LIST";
export declare const PERFORM_INPUT_CUSTOMER = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_CUSTOMER";
export declare const PERFORM_INPUT_COMMENT = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_INPUT_COMMENT";
export declare const PERFORM_CANCEL = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CANCEL";
export declare const PERFORM_SAVE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE";
export declare const PERFORM_SAVE_EXECUTE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_EXECUTE";
export declare const PERFORM_SAVE_SUCCESS = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_SUCCESS";
export declare const PERFORM_SAVE_FAILURE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_SAVE_FAILURE";
export declare const CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE";
export declare const CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_REQUEST = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_REQUEST";
export declare const CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_SUCCESS = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_SUCCESS";
export declare const CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_FAILURE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_FAILURE";
export declare const PERFORM_VALIDATE = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_VALIDATE";
export declare const NAVIGATE_BACK = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_NAVIGATE_BACK";
export declare const PERFORM_CONTAINER_RESET = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CONTAINER_RESET";
export declare const PERFORM_CHANGE_VISIBLE_ERROR_MODAL = "GSZ_ACTIVITY_EXCLUDE_CONTAINER_PERFORM_CHANGE_VISIBLE_ERROR_MODAL";
/**
...
export declare const filterCustomerList: (inputSearch: string, inputSearchManagedOnly: boolean, currentGsz: ModelsCrm.Gsz) => Action<FILTER_CUSTOMER_LIST>;
/**
 ...
 *
 */
export declare type CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE = {};
export declare const callPostGszActivityExcludeCreate: () => Action<CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE>;
/**
 ...
 */
export declare type CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_REQUEST = {};
export declare const callPostGszActivityExcludeCreateRequest: () => Action<CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_REQUEST>;
export declare type CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_SUCCESS = {
    response: Response<boolean>;
};
export declare const callPostGszActivityExcludeCreateSuccess: (response: Response<boolean>) => Action<CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_SUCCESS>;
export declare type CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_FAILURE = {
    error: Error;
};
export declare const callPostGszActivityExcludeCreateFailure: (error: Error) => Action<CALL_POST_GSZ_ACTIVITY_EXCLUDE_CREATE_FAILURE>;
/**
