...
export const performInputCustomer = (customer: Models.Customer, 
                                     currentUser: ModelsApp.Employee): Action<PERFORM_INPUT_CUSTOMER> => ({
 ...
 *
 */
export type CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE = {}
export const callPostGszActivityIncludeCreate = (): Action<CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE> => ({
 ...
 */
export type CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_REQUEST = {}
export const callPostGszActivityIncludeCreateRequest = (): Action<CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_REQUEST> => ({
 ...
 */
export type CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_SUCCESS = { response: Response<boolean> }
export const callPostGszActivityIncludeCreateSuccess = (response: Response<boolean>): Action<CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_SUCCESS> => ({
 ...
 * @param {Error} error Description of error while receiving data by fetch.
 */
export type CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_FAILURE = { error: Error }
export const callPostGszActivityIncludeCreateFailure = (error: Error): Action<CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_FAILURE> => ({
