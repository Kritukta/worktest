...
export const NAVIGATE_TO_AGREEMENT_LIST_VIEW = 'CONTAINER_PRODUCT_ACQUIRING_NAVIGATE_TO_AGREEMENT_LIST_VIEW'
export const NAVIGATE_TO_VIEW_PRODUCT_ACQUIRING = 'CONTAINER_PRODUCT_ACQUIRING_NAVIGATE_TO_VIEW_PRODUCT_ACQUIRING'


/**
 * Thunk dispatched by "ProductAcquiring" screen. Thunk dispatched to navigate to agreement list view.
 */
export type NAVIGATE_TO_AGREEMENT_LIST_VIEW = {}
export const navigateToAgreementListView = (): Action<NAVIGATE_TO_AGREEMENT_LIST_VIEW> => ({
    type: NAVIGATE_TO_AGREEMENT_LIST_VIEW,
    payload: {}
})
 ...
 */
export type NAVIGATE_TO_VIEW_PRODUCT_ACQUIRING = {}
export const navigateBackToViewProductAcquiring = (): Action<NAVIGATE_TO_VIEW_PRODUCT_ACQUIRING> => ({
    type: NAVIGATE_TO_VIEW_PRODUCT_ACQUIRING,
    payload: {}
})
