...
export declare const performInputSumMin: (value: number | null) => Action<PERFORM_INPUT_SUM_MIN>;
/**
 * Thunk dispatched by "ProductPaymentAccount" screen. Thunk dispatched on user input field value.
 *
 * @param {number | null} value .
...
export declare const performInputSumMax: (value: number | null) => Action<PERFORM_INPUT_SUM_MAX>;
/**
