...
import * as thunkProductCashManagement from '../thunk/ThunkProductCashManagement'
 ...
 */
class ContainerProductCashManagement extends React.Component<IProductCashManagementProps, any> {

    constructor (props: IProductCashManagementProps, context: any) {
    ...
    render () {
        return (
            ...
            <ViewProductCashManagement
                testID={ 'test-id-container-product-CashManagement' }
...
export type IProductCashManagementProps = IStateProps & IDispatchProps & { testID: string };
...
export default connect<IStateProps, IDispatchProps, { testID: string }> (mapStateToProps, mapDispatchToProps) (ContainerProductCashManagement)
