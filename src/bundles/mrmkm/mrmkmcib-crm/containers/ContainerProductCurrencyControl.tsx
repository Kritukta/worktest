 ...
 */
class ContainerProductCurrencyControl extends React.Component<IProductCurrencyControlProps, any> {

    constructor (props: IProductCurrencyControlProps, context: any) {
    ...
    render () {
        return (
            ...
            <ViewProductCurrencyControl
                testID={ 'test-id-container-product-CurrencyControl' }
...
export type IProductCurrencyControlProps = IStateProps & IDispatchProps & { testID: string };
...
export default connect<IStateProps, IDispatchProps, { testID: string }> (mapStateToProps, mapDispatchToProps) (ContainerProductCurrencyControl)
