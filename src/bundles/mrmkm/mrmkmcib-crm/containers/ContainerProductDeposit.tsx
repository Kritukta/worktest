...
import * as thunkProductDeposit from '../thunk/ThunkProductDeposit'
 ...
 */
class ContainerProductDeposit extends React.Component<IProductDepositProps, any> {

    constructor (props: IProductDepositProps, context: any) {
    ...
    render () {
        return (
            ...
            <ViewProductDeposit
                testID={ 'test-id-container-product-Deposit' }
...
export type IProductDepositProps = IStateProps & IDispatchProps & { testID: string };
...
export default connect<IStateProps, IDispatchProps, { testID: string }> (mapStateToProps, mapDispatchToProps) (ContainerProductDeposit)
