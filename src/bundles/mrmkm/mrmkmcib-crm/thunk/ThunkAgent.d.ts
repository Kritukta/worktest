...
import { Enums as EnumsShedulerTypeList } from 'mrmkmcib-scheduler';
...
export declare const performInputBirthday: (value: Date | null) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const getAgentScopeActivityList: (agent: Models.Agent, customer: Models.Customer, instanceType: EnumsShedulerTypeList.SchedulerMode) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
