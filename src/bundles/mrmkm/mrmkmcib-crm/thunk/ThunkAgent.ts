...
import {
	...
	HistoryMobileApp,
	Models as ModelsApp,
	navigateBack as navigateBackEmail,
	navigationExecutor,
...
import {
	Enums as EnumsShedulerTypeList,
	EnumsScheduler,
	performActivityListRefresh,
	performCloseActivityScreen,
	performInputActivity,
	performReturnToActivityScreen,
...
export const performSchedulerOpen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(thunkAppScheduler.performSchedulerOpen(null, {
        ...
        , null, null, EnumsScheduler.SchedulerMode.Agent))
 ...
 */
export const performInputFirstName = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const performInputLastName = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const performInputMiddleName = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const navigateToJobPickerScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent

    dispatch(SplitPanelActions.pushContent(Enums.NavigationContentAgentCard.AgentCustomerJobPicker,
 ...
 */
export const performInputJobPosition = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 * Thunk dispatched by "Agent" screen. Thunk dispatched on user input Job field.
 */
export const performInputSearchJobPosition = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const performInputWorkPhone = (value: string,) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!util.isAgentValidateWorkPhoneFailed(reducerState.inputWorkPhone) &&
        reducerState.agentValidationErrorList.indexOf(
			reducerState.inputWorkPhone && reducerState.inputWorkPhone[1] === "7" 
 ...
 */
export const performInputMobilePhone = (value: string,) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!util.isAgentValidateMobilePhoneFailed(reducerState.inputMobilePhone) &&
        reducerState.agentValidationErrorList.indexOf(
			reducerState.inputMobilePhone && reducerState.inputMobilePhone[1] === "7" 
 ...
 */
export const performInputEmail = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const performInputBirthday = (value: Date | null) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState ()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent

    if (value) dispatch ( actionsAgent.performInputBirthday ( value ) )
 ...
 */
export const performInputGender = (value: Enums.GenderList) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
 ...
 */
export const navigateToRelationTypePickerScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent

    dispatch(SplitPanelActions.pushContent(Enums.NavigationContentAgentCard.AgentRelationTypeChoice,
        Utils.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen)))
 ...
 */
export const performInputRelationType = (value: ModelsApp.Classifier) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
...
export const performClearCacheCurrentAgent = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
...
export const performOpenCustomerScreen = (customer: Models.AgentCustomerPosition) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    switch  (reducerState.agentContextMode){
        case Enums.AgentContextMode.Scheduler: {
            ...
            dispatch(HistoryMobileApp.pushContent({
                ...
                data: {...defaultValues.HistoryMobileAppData}
            }))

            dispatch(performNavigateToEntity({...defaultValues.NavigateToEntity,
                customerMode: Enums.CustomerMode.SameType,
                navigationType: EnumsApp.NavigationType.Customer,
                customer: {...defaultValues.Customer, id: customer.customerId, ...customer}}))
        ...
        case Enums.AgentContextMode.Customer: {
            ...
            dispatch(performAddAgentToHistoryMobileApp(Enums.NavigationContentAppCrm.AppCRM_Customer,
                util.getNavigationString(Enums.Navigation.AppCRM), {...defaultValues.CustomerManaged, ...customer}))

            if (customer) {
                dispatch(thunkCustomer.navigateToCustomerScreen({
                        ...defaultValues.CustomerManaged,
                        id: customer.customerId || '',
                        legalFormClassifier: customer.legalFormClassifier ,
 ...
 */
export const callPostAgentCreate = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!reducerState.agentCreateFetching) {
        ...
        util.call<Models.ResponsePostPutRequest, Models.DataForCreateAgentRequest>(
            util.urlAgent.callPostAgentCreate(state, [{tag: Enums.CachePolicy.Disabled}]),
            ...
            Converters.AGENT_CREATE_REQUEST,

            {
                ...
                customer: {...defaultValues.Customer, id: reducerState.currentCustomerManaged.id},
 ...
 */
export const callPutAgentUpdate = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!reducerState.agentUpdateFetching) {
        ...
        util.call<Models.ResponsePostPutRequest, Models.DataForUpdateAgentRequest>(
            ...
            Converters.AGENT_UPDATE_REQUEST,
...
export const performEdit = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    let currentAgent: Models.Agent = state.user.mrmkmcibCRM.reducerAgent.currentAgent
    let currentCustomerManaged: Models.CustomerManaged = state.user.mrmkmcibCRM.reducerCustomer.currentCustomerManaged
...
export const performCloseAgentScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    switch (reducerState.agentContextMode) {
        ...
        case Enums.AgentContextMode.Activity: {
            dispatch(HistoryMobileApp.popContent(Utils.getNavigationString(Enums.Navigation.AppCRM))).then((content: ModelsApp.HistoryMobileAppContent)=> {
                if (content && content.payload && content.payload.agent && content.type === EnumsApp.HistoryMobileAppType.Agent) {

                    dispatch(performOpenAgentScreen(
                        content.payload.agent.data,
        ...
        case Enums.AgentContextMode.Deal: {
            ...
            dispatch(HistoryMobileApp.popContent(Utils.getNavigationString(Enums.Navigation.AppCRM))).then((content: ModelsApp.HistoryMobileAppContent)=> {
                if (content && content.payload && content.payload.agentList && content.type == EnumsApp.HistoryMobileAppType.AgentList && content.payload.agentList.deal) {
                    ...
                    dispatch(thunkAgentList.performOpenAgentListScreen(content.payload.agentList.data,
                        {...defaultValues.CustomerManaged, ...content.payload.agentList.deal.customer},content.payload.agentList.deal,content.payload.agentList.contextMode, content.payload.agentList.accessLevel))
        ...
        case Enums.AgentContextMode.OwnerAgent: {
            dispatch(HistoryMobileApp.popContent(Utils.getNavigationString(Enums.Navigation.AppCRM))).then((content: ModelsApp.HistoryMobileAppContent)=> {
                if (content && content.payload && content.payload.agentList && content.type == EnumsApp.HistoryMobileAppType.AgentList) {
                    ...
                    dispatch(thunkAgentList.performOpenAgentListScreen(content.payload.agentList.data,
                        {...defaultValues.CustomerManaged, ...content.payload.agentList.customer},null,content.payload.agentList.contextMode, content.payload.agentList.accessLevel))
...
export const perfromCloseAgentOccasionListScreen = (agent: Models.Agent) => (dispatch: Function, getState: () => ModelState.IRootState): void => {

    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    dispatch(HistoryMobileApp.popContent(util.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen))).then((content: ModelsApp.HistoryMobileAppContent) => {
        if (content && content.payload && content.payload.agent) {
            ...
            if (reducerState.agentMode == Enums.AgentMode.Watch) {
                ...
                dispatch(thunkAgent.performOpenAgentScreen(agent,
                    ...
                    reducerState.agentMode,
                    reducerState.agentContextMode))
            }
...
export const perfromCloseAgentNoteListScreen = (agent: Models.Agent) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
...
export const performAddAgentToHistoryMobileApp = (index: number, splitPanelName: string, customer: Models.Customer) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(HistoryMobileApp.pushContent({
        ...
        data: {
            ...
            agent: {
                data: {...reducerState.currentAgent},
                customer: {...defaultValues.Customer, ...customer},
 ...
 * @param {boolean}
 */
export const performChangeDisplayAgentErrorModalWindow = (value: boolean)  => (dispatch: Function, getState: () => ModelState.IRootState): void => {
 ...
 */
export const navigateToOccasionList = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let currentAgent = state.user.mrmkmcibCRM.reducerAgent.currentAgent
    ...
    dispatch(performAddAgentToHistoryMobileApp(Enums.NavigationContentAgentCard.AgentOccasionList,
        util.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen), reducerAgent.currentCustomerManaged))

    dispatch(thunkOccasionList.performOpenOccasionListScreen(
        reducerAgent.inputOccasionList,
        {...defaultValues.OccasionListConfig,
            contextMode: occasionListContextMode,
            currentAgent,
 ...
 * Thunk dispatched by "Agent" screen. Thunk chain used to navigate.
 */
export const navigateToOccasionAgentListFromPush = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent

    dispatch(performAddAgentToHistoryMobileApp(Enums.NavigationContentAgentCard.AgentOccasionList,
        util.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen), reducerState.currentCustomerManaged))


    dispatch(thunkOccasionList.performOpenOccasionListScreen(
        reducerState.currentAgent.occasionList,
        {...defaultValues.OccasionListConfig,
            currentAgent: reducerState.currentAgent,
            currentCustomer: reducerState.currentCustomerManaged,
            contextMode: Enums.OccasionListContextMode.Notice}
    ))
 ...
 * Thunk dispatched by "Agent" screen. Thunk chain used to navigate.
 */
export const navigateToNoteList = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    dispatch(performAddAgentToHistoryMobileApp(Enums.NavigationContentAgentCard.AgentNoteList,
        Utils.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen),
        reducerState.currentCustomerManaged))

    dispatch(thunkNoteList.navigateToNoteListScreen(reducerState.currentAgent.noteList,
        reducerState.currentAgent,
        state.user.mrmkmcibCRM.reducerCustomer.currentCustomerManaged,
        reducerState.agentMode == Enums.AgentMode.Watch
            ? Enums.NoteListContextMode.Agent
            : Enums.NoteListContextMode.NewEditAgent,
 ...
 */
export const navigateToAgentComment = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    dispatch (SplitPanelActions.pushContent (Enums.NavigationContentAgentCard.AgentComment,
        Utils.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen)))
 ...
 */
export const performSetAgentCommentEditStatus = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
...
export const performInputAgentNoteList = (noteList: Models.NoteList) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
...
export const performInputAgentOccasionList = (occasionList: Models.OccasionList) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
...
export const performCreateActivityAccessRequest = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(performInputActivity(
        EnumsScheduler.SchedulerMode.Agent,
        {   ...defaultValues.Activity,
            author: state.user.mrmkmcibCRM.reducerAppCRM.currentUser,
            customer: currentCustomerManaged,
            agentList: {data: [currentAgent]},
            description: `Прошу предоставить доступ к карточке ` +
            `${Utils.getAgentNameInitials(currentAgent)}, представителя компании ${currentCustomerManaged.name}.`,
            type: {code: 'Task', parentId: null, name: 'TODO_TYPE', value: 'Задача'},
            memberList: Utils.findGeneralMember(currentAgent.memberList),
        }, EnumsScheduler.ActivityMode.Create, EnumsScheduler.ActivityContextMode.AgentAccess
    ))
}

export const navigateToMemberList = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(thunkMemberList.performMemberListRefresh(
        ...
        defaultValues.CustomerManaged,
        defaultValues.Gsz,
        {...reducerState.currentAgent, memberList: reducerState.inputMemberList || defaultValues.MemberList},
        true, Enums.MemberListMode.Agent))

    dispatch (SplitPanelActions.pushContent(Enums.NavigationContentAgentCard.AgentMemberList,
        Utils.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen)))

}
export const performSaveAgentComment = () => (dispatch: Function, getState: ()=> ModelState.IRootState): void => {
...
export const performGetUncachedAgent = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
 ...
 */
export const performOpenAgentScreen = ( agent: Models.Agent,
                                        currentCustomerManaged: Models.CustomerManaged,
                                        agentMode: Enums.AgentMode,
                                        agentContextMode: Enums.AgentContextMode) => (dispatch: Function, getState: () => ModelState.IRootState): void => {

    dispatch(actionsAgent.performInputAgent(agent,
...
export const getAgentScopeActivityList = (agent: Models.Agent, customer: Models.Customer, instanceType: EnumsShedulerTypeList.SchedulerMode) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
 ...
 */
export const performAgentCurrentModeRefresh = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    if (reducerState.currentAgent.id) {
        Cache.sessionResetTagList([{tag:
            util.getRefreshAgentAfterMemberListUpdateTagString(Enums.RefreshAgentAfterMemberListUpdateTag.RefreshAgentAfterMemberListUpdateEnabled)}])
        dispatch(thunkAgent.callGetAgent(reducerState.currentAgent))
    }
...
const performGrantAccessToAgent = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    dispatch(actionsAgent.performInputAgent(currentAgent,
        currentCustomerManaged,
        state.user.mrmkmcibCRM.reducerAgent.agentMode,
        state.user.mrmkmcibCRM.reducerAgent.agentContextMode ))
...
export const callGetAgentSuccess=  (response: Response<Models.Agent>) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (reducerState.agentContextMode !== Enums.AgentContextMode.Scheduler) {
        if (reducerState.currentAgent.accessLevel == Enums.AgentAccessLevel.Denied) {
            ...
            dispatch(getAgentScopeActivityList(reducerState.currentAgent, 
                reducerState.currentCustomerManaged, 
                EnumsScheduler.SchedulerMode.None)) 
 ...
 */
export const callGetAgent = (agent: Models.Agent) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!reducerState.currentAgentFetching) {
        ...
        util.call<Models.Agent, void>(
            util.urlAgent.callGetAgent(state, agent, [
            ...
            (response: Response<Models.Agent>) => {
                ...
                dispatch(thunkAgent.callGetAgentSuccess({
                   data: {...response.data, accessLevel: util.setAccessLevelToAgent(userMember)},
            ...
            Converters.RESPONSE_AGENT_CALL_GET_AGENT_TO_AGENT,
...
export const callGetUpdateAgentFailure = (error: Models.Error) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
 ...
 */
export const callGetAgentById = (agentId: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
    ...
    if (!reducerState.currentAgentFetching) {
        ...
        util.call<Models.Agent, void>(
            util.urlAgent.callGetAgentById(
                state,
                agentId,
                [
                    {
                    ...
                    {
                        tag: util.getRefreshAgentAfterMemberListUpdateTagString(
                            Enums.RefreshAgentAfterMemberListUpdateTag.RefreshAgentAfterMemberListUpdateEnabled
                        )
                    },
                ]
            ),
            ...
            (error: Error) => {
                ...
                dispatch(navigationExecutor(
                    ...
                    `Ошибка на этапе загрузке данных об агенте: ${error.code} - ${error.message}`,
                ))
 ...
 */
export const navigateToAgentCustomerPositionListScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent

    dispatch(SplitPanelActions.pushContent(Enums.NavigationContentAgentCard.AgentCustomerCompaniesList,
        Utils.getNavigationAppCrmString(Enums.NavigationAppCRM.AgentScreen)))
 ...
 * Thunk dispatched by "Agent" screen.
 */
export const resetNavigatePanel = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerAgent
