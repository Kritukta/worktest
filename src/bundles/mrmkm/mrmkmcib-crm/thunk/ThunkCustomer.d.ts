...
export declare const callGetCustomerActivityList: (customerActivityList: Models.CustomerManaged | null) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const navigateToCurrentCustomerAgentScreen: (agentId: string | null | undefined) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
