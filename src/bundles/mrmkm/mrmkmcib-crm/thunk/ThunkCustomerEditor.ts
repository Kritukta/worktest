 ...
 */
export const performCustomerEditorShow = (customer: Models.CustomerManaged,) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
 ...
 */
export const swapContext = (customer: Models.CustomerManaged, isEditorMode: boolean,) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
...
export const performCancel = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(SplitPanelActions.resetSplitPanel(
        util.getNavigationiewCustomerEditorMainString(Enums.NavigationViewCustomerEditorMain.AppCRM_CustomerEditor)
    ))
    dispatch(SplitPanelActions.resetSplitPanel(
        util.getNavigationiewCustomerEditorMainString(Enums.NavigationViewCustomerEditorMain.AppCRM_CustomerEditor_Form)
    ))
    dispatch(SplitPanelActions.resetSplitPanel(
        util.getNavigationCustomerEditInIncludeExcludeOrganizationString(Enums.NavigationCustomerEditInIncludeExcludeOrganization.EditorContainer)
    ))
...
export const performNext = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    if(!(
        reducerState.inputBlockValidationError      ||
        ...
        dispatch(SplitPanelActions.pushContent(
            Enums.NavigationViewCustomerEditorStep.AppCRM_CustomerEditor_View,
            util.getNavigationiewCustomerEditorMainString(Enums.NavigationViewCustomerEditorMain.AppCRM_CustomerEditor_Form)
        ))
 ...
 */
export const performCustomerOpenAfterSaveSuccess = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
...
export const callGetCustomerModifierId = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    if (!reducerState.customerModifierIdFetching) {
        ...
        util.call<Models.CustomerManaged, void>(
            util.urlCustomerEditor.callGetCustomerModifierId(state, reducerState, [{tag: Enums.CachePolicy.Disabled}]),
 ...
 */
export const callPutCustomerUpdate = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
    ...
    if (!reducerState.customerUpdateFetching) {
        ...
        util.call<boolean, Models.CustomerUpdateRequest>(
            util.urlCustomerEditor.callPutCustomerUpdate(state, reducerState.currentCustomerManaged, [{tag: Enums.CachePolicy.Disabled}]),
            ...
            Converters.RESPONSE_CUSTOMER_EDITOR_CALL_PUT_CUSTOMER_UPDATE_TO_BOOLEAN,

            'PUT',
            {'Content-type': 'application/json; charset=UTF-8'},

            Converters.REQUEST_CUSTOMER_EDITOR_CALL_PUT_CUSTOMER_UPDATE_FROM_CUSTOMER_UPDATE_REQUEST,

            {
                ...
                address: {
                    ...
                    region: reducerState.inputRegion,
                    building: reducerState.inputBuilding,
                    city: reducerState.inputCity,
                    country: reducerState.inputCountry,
                    id: reducerState.currentCustomerManaged.address ? reducerState.currentCustomerManaged.address.id : null,
                    isActive: reducerState.currentCustomerManaged.address ? reducerState.currentCustomerManaged.address.isActive : null,
                    isPrimary: reducerState.currentCustomerManaged.address ? reducerState.currentCustomerManaged.address.isPrimary : null,
                    modId: reducerState.customerModifierId.address ? reducerState.customerModifierId.address.modId : 0,
                    settlement: reducerState.inputSettlement,
                    subject: reducerState.inputSubject,
                    street: reducerState.inputStreet,
                    type: reducerState.currentCustomerManaged.address ? reducerState.currentCustomerManaged.address.type : null,
                    house: reducerState.inputHouse,
                    block: reducerState.inputBlock,
                    flat: reducerState.inputFlat,
                }
            }
        )
    }
 ...
 */
export const navigateToCountryPickerScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputCountry = (value: ModelsApp.Classifier) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputSubject = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputRegion = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputCity = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputSettlement = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputStreet = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputHouse = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputBuilding = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputBlock = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const performInputFlat = (value: string) => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const navigateToCustomerActivityIncludeScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
    ...
    switch (reducerState.customerEditorActivityCreateMode) {
        case Enums.CustomerEditorActivityCreateMode.Exclude: {
            ...
            dispatch(SplitPanelActions.popContent(util.getNavigationCustomerEditInIncludeExcludeOrganizationString(
                Enums.NavigationCustomerEditInIncludeExcludeOrganization.EditorContainer)))
			...
			if (reducerState.customerEditorActivityCreateMode !== Enums.CustomerEditorActivityCreateMode.Exclude){
				setTimeout( () => {
	           		dispatch(SplitPanelActions.pushContent(
                		Enums.NavigationCustomerEditorIncludeExclude.AppCRM_CustomerEditor_Include,
                		util.getNavigationCustomerEditInIncludeExcludeOrganizationString(Enums.NavigationCustomerEditInIncludeExcludeOrganization.EditorContainer)))					
				}, 1000)
			}
 ...
 */
export const navigateToCustomerActivityExcludeScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
    ...
    switch (reducerState.customerEditorActivityCreateMode) {
        case Enums.CustomerEditorActivityCreateMode.Include: {
			...
			if (reducerState.customerEditorActivityCreateMode !== Enums.CustomerEditorActivityCreateMode.Include){
				setTimeout(() => {
					dispatch(SplitPanelActions.pushContent(
                		Enums.NavigationCustomerEditorIncludeExclude.AppCRM_CustomerEditor_Exclude,
                		util.getNavigationCustomerEditInIncludeExcludeOrganizationString(Enums.NavigationCustomerEditInIncludeExcludeOrganization.EditorContainer)
           			))
				}, 1000)
			}
 ...
 */
export const closeCustomerActivityPanel = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
 ...
 */
export const navigateCustomerEditorBack = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerCustomerEditor
