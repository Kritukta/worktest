...
export declare const navigateToParentDealScreen: (deal: Models.Deal, dealMode: Enums.DealMode, isEditDealEnable: boolean, customerId?: string | null | undefined) => (dispatch: Function) => void;
/**
...
export declare const navigateToDealScreen: (dealId: string, dealMode: Enums.DealMode, isEditDealEnable: boolean, customerId?: string | null | undefined) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
export declare const performRefresh: (dealId?: string | undefined, customerId?: string | null | undefined) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
