...
export const navigateToCustomerPickerScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(SplitPanelActions.pushContent(Enums.NavigationIntoGSZExcludeIncludeView.IncludeExclude_ClientsSearch, 
        util.getNavigationGszEditInIncludeExcludeOrganizationString(Enums.NavigationGszEditInIncludeExcludeOrganization.Gsz_CustomerEditor_Include_View)))
...
export const search_callGetCustomerSearchList = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    if (!reducerState.customerSearchListFetching) {
        ...
        util.call<Models.CustomerList, void>(
            util.urlGszActivityInclude.search_callGetCustomerSearchList(state, reducerState, [{tag: Enums.CachePolicy.Default}]),
            ...
            Converters.RESPONSE_GSZ_ACTIVITY_INCLUDE_SEARCH_CALL_GET_CUSTOMER_SEARCH_LIST_TO_CUSTOMER_LIST,
 ...
 */
export const callPostGszActivityIncludeCreate = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    let state = getState()
    let reducerState = state.user.mrmkmcibCRM.reducerGszActivityInclude
    ...
    if (!reducerState.activityIncludeCreateFetching) {
        ...
        util.call<boolean, Models.GszActivityIncludeCreateRequest>(
            util.urlGszActivityInclude.callPostGszActivityIncludeCreate(state, reducerState, [{tag: Enums.CachePolicy.Disabled}]),
            ...
            Converters.RESPONSE_GSZ_ACTIVITY_INCLUDE_CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_TO_BOOLEAN,

            'POST',
            {'Content-type': 'application/json; charset=UTF-8', 'operuid': reducerState.operationUuid},

            Converters.REQUEST_GSZ_ACTIVITY_INCLUDE_CALL_POST_GSZ_ACTIVITY_INCLUDE_CREATE_FROM_GSZ_ACTIVITY_INCLUDE_CREATE_REQUEST,
...
export const navigateToMemberListScreen = () => (dispatch: Function, getState: () => ModelState.IRootState): void => {
    ...
    dispatch(thunkMemberList.performMemberListRefresh(
        ...
        defaultValues.Agent, 
        true,
        Enums.MemberListMode.CustomerActivityAddGSZ))
