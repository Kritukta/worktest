...
export declare const performInputForecastEventDate: (value: Date | null) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performInputForecastEventSum: (value: string | null) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
...
export declare const performChangeCovenantDateFilterValue: (value: Date | null) => (dispatch: Function) => void;
...
export declare const performInputPaymentScheduleFilterPeriodEnd: (value: Date | null) => (dispatch: Function) => void;
export declare const performPopoverPaymentSchedulePeriodSwitchDatePicker: (value: boolean) => (dispatch: Function) => void;
export declare const performInputPaymentScheduleFilterPeriodStart: (value: Date | null) => (dispatch: Function) => void;
export declare const performInputPaymentScheduleFilterPeriodStartApplied: (value: Date | null) => (dispatch: Function) => void;
export declare const performInputPaymentScheduleFilterPeriodEndApplied: (value: Date | null) => (dispatch: Function) => void;
 ...
 */
export declare const performPaymentScheduleFilterPeriodSet: (dateStart: Date | null, dateEnd: Date | null) => (dispatch: Function) => void;
/**
 * Thunk dispatched by "ProductCredit" container. Set date in filter period applied
 */
export declare const performPaymentScheduleFilterPeriodSetApplied: (dateStart: Date | null, dateEnd: Date | null) => (dispatch: Function) => void;
/**
 *
 */
 ...
 * @return void
 */
export declare const alternativeScenariosHandlerRequestedPeriodTooLarge: (dateStart: Date, dateEnd: Date, dateStartDefault: Date | null, dateEndDefault: Date | null) => (dispatch: Function, getState: () => ModelState.IRootState) => void;
/**
 * Thunk dispatched by "ProductCredit" container. Remove forecast events from cache and execute performRefreshForecast
 */
export declare const performPaymentScheduleAlertShow: (paymentScheduleAlternativeScenariosType: Enums.paymentScheduleAlternativeScenariosType, paymentScheduleAlternativeScenariosMessage: string | null, paymentScheduleAlternativeScenariosTitle?: string | null) => (dispatch: Function) => void;
/**
 * Thunk dispatched by "ProductCredit" container. Remove forecast events from cache and execute performRefreshForecast
 */
 ...
 * Thunk dispatched by "ProductCredit" container. Remove forecast events from cache and execute performRefreshForecast
 */
export declare const performPaymentScheduleErrorShow: (paymentScheduleAlternativeScenariosType: Enums.paymentScheduleAlternativeScenariosType, paymentScheduleAlternativeScenariosMessage: string | null, paymentScheduleAlternativeScenariosTitle?: string | null) => (dispatch: Function) => void;
/**
 * Thunk dispatched by "ProductCredit" container. Remove forecast events from cache and execute performRefreshForecast
 */
