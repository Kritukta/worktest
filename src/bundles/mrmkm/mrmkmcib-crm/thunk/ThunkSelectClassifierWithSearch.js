 ...
 */
export const performSearch = (value) => (dispatch, getState) => {
 ...
 * Thunk dispatched by "ClassifierSelectorWithSearchContainer" screen. Thunk chain dispatched on tab selector change current tab.
 */
export const showSearchLine = () => (dispatch, getState) => {
    dispatch(actionsClassifier.showSearchLine());
};
/*
 * Thunk dispatched by "ClassifierSelectorWithSearchContainer" screen. Thunk chain dispatched on tab selector change current tab.
 */
export const hideSearchLine = () => (dispatch, getState) => {
    dispatch(actionsClassifier.hideSearchLine());
};
/*
 * Thunk dispatched by "ClassifierSelectorWithSearchContainer" screen. Thunk chain dispatched on tab selector change current tab.
 */
export const performInit = (list, value, mode, pageName, navigateBackButtonTitle, isFullScreenEnabled) => (dispatch, getState) => {
    dispatch(actionsClassifier.performInit(list, value, mode, pageName, navigateBackButtonTitle, isFullScreenEnabled));
};
export const performEnableSearch = (isSearchEnable) => (dispatch, getState) => {
 ...
 * Thunk dispatched by "ClassifierSelectorWithSearchContainer" screen. Thunk chain dispatched on tab selector change current tab.
 */
export const performSelect = (value) => (dispatch, getState) => {
    let state = getState();
...
export const navigateToClassifier = (classifierList, initialValue, mode, warningMessage) => (dispatch, getState) => {
    ...
    switch (mode) {
        case Enums.ClassifierMode.DealEditor_Product: {
            ...
            dispatch(SplitPanelActions.pushContent(Enums.NavigationContentDealEditor.AppCRM_DealEditor_ClassifierProduct, util.getNavigationContentString(Enums.NavigationContentAppCrm.AppCRM_DealEditor)));
            break;
        }
        case Enums.ClassifierMode.DealEditor_SalesMethod: {
            ...
            dispatch(SplitPanelActions.pushContent(Enums.NavigationContentDealEditor.AppCRM_DealEditor_ClassifierSalesMethod, util.getNavigationContentString(Enums.NavigationContentAppCrm.AppCRM_DealEditor)));
            break;
        }
        case Enums.ClassifierMode.DealEditor_Currency: {
            ...
            dispatch(thunkSelectClassifierWithSearch.performEnableSearch(true)); // нужен ли поиск (по умолчанию false)
            dispatch(SplitPanelActions.pushContent(Enums.NavigationContentDealEditor.AppCRM_DealEditor_ClassifierCurrency, util.getNavigationContentString(Enums.NavigationContentAppCrm.AppCRM_DealEditor)));
            break;
        }
        case Enums.ClassifierMode.DealStage_Currency: {
            ...
            dispatch(thunkSelectClassifierWithSearch.performEnableSearch(true)); // нужен ли поиск (по умолчанию false)
            dispatch(SplitPanelActions.pushContent(Enums.NavigationContentDealStage.Currency, util.getNavigationContentString(Enums.NavigationContentAppCrm.AppCRM_DealStage)));
            break;
        }
        case Enums.ClassifierMode.Agent_Note: {
            ...
            dispatch(thunkSelectClassifierWithSearch.performEnableSearch(false)); // нужен ли поиск (по умолчанию false)
            dispatch(SplitPanelActions.pushContent(Enums.NavigationNoteScreen.Type, util.getNavigationNoteList(Enums.NavigationNoteList.NoteScreen)));
            break;
        }
        case Enums.ClassifierMode.DealEditor_DealType: {
            ...
            dispatch(thunkSelectClassifierWithSearch.performEnableSearch(false)); // нужен ли поиск (по умолчанию false)
            dispatch(SplitPanelActions.pushContent(Enums.NavigationContentDealEditor.AppCRM_DealEditor_ClassifierDealType, util.getNavigationContentString(Enums.NavigationContentAppCrm.AppCRM_DealEditor)));
            break;
        }
        default: break;
    }
};
export const setClassifierWarning = (warningMessage) => (dispatch, getState) => {
    dispatch(actionsClassifier.setClassifierWarning(warningMessage));
};
//# sourceMappingURL=ThunkSelectClassifierWithSearch.js.map