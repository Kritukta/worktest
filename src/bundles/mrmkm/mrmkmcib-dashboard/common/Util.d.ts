...
export declare const getUrlForRole: (role: number | null, supParams: Models.SupParams) => string;
...
export declare const call: <T, TB>(url: Models.Url, success: (response: Response<T>) => void, failure: (response: Error) => void, converter: (data: any) => T, method?: string, headers?: any, requestConverter?: (data: TB) => any, requestData?: TB | null) => void;
...
export declare const recoverSearchHistoryListFromStorage: () => React.Promise<Models.SearchHistoryList>;
export declare const persistSearchHistoryListToStorage: (list: Models.SearchHistoryList) => React.Promise<string>;
export declare const recoverPeopleHistoryListFromStorage: () => React.Promise<ModelsScheduler.PersonList>;
export declare const persistPeopleHistoryListToStorage: (list: ModelsScheduler.PersonList) => React.Promise<string>;
...
export declare const getCookieString: (data: CookieData[] | null) => string | null;
